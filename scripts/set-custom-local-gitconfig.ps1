...
@echo off
echo.
echo Error: This script must be run from a PowerShell version 7.6.0 terminal.
echo.
exit /b 1
#>
...
.EXAMPLE
    .\set-custom-local-gitconfig.ps1
...
function Set-CustomLocalGitconfig {
    <#
    .SYNOPSIS
