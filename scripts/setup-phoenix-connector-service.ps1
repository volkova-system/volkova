...
.DESCRIPTION
    The setup-phoenix-connector-service PowerShell script automates the scaffolding of
...
.EXAMPLE
    ...
    .\scripts\setup-phoenix-connector-service.ps1 -ServiceName 'setting-service'
...
function Invoke-PrimaryWorkflow {
    ...
    Write-InfoLog -Scope "SETUP-MAIN" `
        -Message "Starting setup-phoenix-connector-service workflow"
