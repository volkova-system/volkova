...
func main() {
    ...
    sessionsGroup.Get("/health", func(c fiber.Ctx) error {
    ...
    sessionsGroup.Post("/stop", func(c fiber.Ctx) error {
		go func() {
			shutdownCh <- struct{}{}
		}()
	...
	RegisterSessionRoutes(sessionsGroup, cache)
