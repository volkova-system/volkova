// Package data provides an in-memory caching layer for runtime data using BuntDB.
// It offers efficient storage and retrieval of runtime information with indexing
...
func Open() (*Cache, error) {
    dbPath := os.Getenv("RUNTIME_CACHE_PATH")
