...
func main() {
    ...
    runtimesGroup.Get("/health", func(c fiber.Ctx) error {
    ...
    runtimesGroup.Post("/stop", func(c fiber.Ctx) error {
		go func() {
			shutdownCh <- struct{}{}
		}()
	...
	RegisterRuntimeRoutes(runtimesGroup, cache)
