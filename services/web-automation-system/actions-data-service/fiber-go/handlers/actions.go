...
func getActionsFromCache(c fiber.Ctx, cache *data.Cache) error {
	...
	if err != nil {
		return IssueResponse(c, fiber.StatusBadRequest, "invalid actions request parameters")
	}
	...
	if err != nil {
		return IssueResponse(c, fiber.StatusInternalServerError, "action cache count error")
	}
