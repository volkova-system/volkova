...
func getRuntimesFromCache(c fiber.Ctx, cache *data.Cache) error {
	...
	if err != nil {
		return IssueResponse(c, fiber.StatusBadRequest, "invalid runtimes request parameters")
	}
	...
	if err != nil {
		return IssueResponse(c, fiber.StatusInternalServerError, "runtime cache count error")
	}
