...
func main() {
    ...
    tasksGroup.Get("/health", func(c fiber.Ctx) error {
    ...
    tasksGroup.Post("/stop", func(c fiber.Ctx) error {
		go func() {
			shutdownCh <- struct{}{}
		}()
	...
	RegisterTaskRoutes(tasksGroup, cache)
