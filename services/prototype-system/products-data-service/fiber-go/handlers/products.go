...
//
func GetProductsHandler(cache *data.Cache) fiber.Handler {
...
//
func getProductsFromCache(c fiber.Ctx, cache *data.Cache) error {
...
//
func retrieveProductsFromCache(cache *data.Cache, skip, limit int) (
	interface{}, error) {
